                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                {{ $totalDistributions }} Product
                                            </div>
                                            <div class="text-secondary">
                                                Distribution to Konsumen
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card card-sm">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="font-weight-medium">
                                                {{ $totalProductsNotDistributed }} Product
                                            </div>
                                            <div class="text-secondary">
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter table-mobile-md card-table">
                                ...
                                <tbody id="tableBody">
                                    @foreach ($productsblmkirim as $data)
                                        <tr>
                                            <td data-label="Name">
                                                {{ $data->name }}
                                            </td>
                                            ...
                                            <td>
                                                <div class="text-end">
                                                    <a href="{{ route('distribution.create', $data) }}"
