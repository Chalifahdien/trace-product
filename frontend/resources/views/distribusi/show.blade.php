            ...
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <div class="page-pretitle">
                        Home / Distribution / {{ $product->name }}
                    </div>
                    <h2 class="page-title">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a href="{{ route('distribution.create', $product) }}" class="btn btn-primary btn-5">
                                ...
                                <tbody id="tableBody">
                                    @foreach ($stages as $stage)
                                        <tr>
                                            ...
                                            <td data-label="Location">{{ $stage->distributor->name }}</td>
                                            <td data-label="Executor">{{ $stage->distributed_at }}</td>
