                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs nav-fill" data-bs-toggle="tabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a href="#stage" class="nav-link active" data-bs-toggle="tab" aria-selected="true"
                                        role="tab">Detail</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a href="#dis" class="nav-link" data-bs-toggle="tab" aria-selected="false"
                                        tabindex="-1" role="tab">Distribution</a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active show" id="stage" role="tabpanel">
                                    <div class="card">
                                        <div class="card-header">
                                ...
                                <div class="tab-pane" id="dis" role="tabpanel">
                                    <div class="card">
                                        ...
                                        <div class="card-footer pb-0">
                                            <div class="d-flex justify-content-center" id="paginationContainer1"
                                                hidden>
